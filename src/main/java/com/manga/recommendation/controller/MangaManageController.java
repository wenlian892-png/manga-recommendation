...
public class MangaManageController {
    ...
    public Result<Void> addManga(@RequestBody MangaAddRequest request) {
        try {
    ...
    public Result<Void> updateManga(@PathVariable Long id, @RequestBody MangaAddRequest request) {
        try {
